...
to-report dx-dt
  let x xcor / max-pxcor
  let y ycor / max-pycor
  let fit-row-u pay-row-ul * y + pay-row-ur * ( 1 - y )
  let fit-row-d pay-row-dl * y + pay-row-dr * ( 1 - y )
  report x * ( 1 - x ) * ( fit-row-u - fit-row-d )
end

to-report dy-dt
  let x xcor / max-pxcor
  let y ycor / max-pycor
  let fit-col-l pay-col-ul * x + pay-col-dl * ( 1 - x )
  let fit-col-r pay-col-ur * x + pay-col-dr * ( 1 - x )
  report y * ( 1 - y ) * ( fit-col-l - fit-col-r )
end
