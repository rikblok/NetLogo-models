...
; given latest round of play, update a player's statistics
  ...
  [ set rounds-played     rounds-played     + 1
    ...
    set total-score       total-score       + mutual-benefit * your-choice * my-choice - cost-to-self * my-choice
...
* **mutual-benefit**: The benefit received if the both players chooses to cooperate.  When the benefit is more than the cost there is an incentive to coordinate with the other player -- a Stag hunt scenario.
